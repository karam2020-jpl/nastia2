import 'server-only';
import {ensureCategories,listCategories} from '../category-store';
import {ensureProductImages,getProductImages} from '../product-images';
import {DatabaseSync} from 'node:sqlite';
import {mkdirSync} from 'node:fs';
import {dirname,resolve} from 'node:path';
import {initialDelivery,initialProducts,Product,categories} from '../data';
...
ensureCategories(db,categories);
export const getCategories=()=>listCategories(db);
