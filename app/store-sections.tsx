...
export function FeaturedProducts() {
  ...
  return <section className="section featured-section"><div className="title-row"><h2>مختارات لكِ</h2><Link href="/products">عرض الكل ←</Link></div><div className="grid">{products.slice(0,4).map((product) => <ProductCard p={product} key={product.id} />)}</div></section>;
}
