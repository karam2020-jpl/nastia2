export const roleLabels = {owner:'المالك', orders:'مسؤول الطلبات', products:'مسؤول المنتجات', content:'مسؤول المحتوى'} as const;
export type AdminRole = keyof typeof roleLabels;
export type Permission = 'orders' | 'products' | 'content' | 'delivery' | 'users' | 'audit';
